...
using Lykke.Job.TxDetector.TriggerHandlers;
...
namespace Lykke.Job.TxDetector
{
    class Program
    {
        ...
        {
            Console.WriteLine($"Version: { Microsoft.Extensions.PlatformAbstractions.PlatformServices.Default.Application.ApplicationVersion}");
